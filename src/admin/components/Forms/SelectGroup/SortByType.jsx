...
const SortByType = () => {
    const { selectedFreeOrPaid, handleFreeOrPaidChange } = useFilter()
    return (
            ...
            <div className="relative z-20 bg-transparent dark:bg-form-input">
                <select
                    className=" relative z-20 w-full appearance-none rounded border
                     border-stroke bg-transparent py-3 px-7 outline-none transition focus:border-primary
                      active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary
                       text-black dark:text-white "
                    value={selectedFreeOrPaid} onChange={handleFreeOrPaidChange}
                >
