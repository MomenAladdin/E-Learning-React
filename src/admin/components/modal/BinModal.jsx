...
const BinModal = ({ id, handleDelete, text }) => {

    return (
        <>
            <button className="hover:text-red-600" onClick={() => document.getElementById(`modal1_${id}`).showModal()}>
                <svg
            ...
            <dialog id={`modal1_${id}`} className="modal ">
                <div className="modal-box dark:bg-boxdark dark:text-white">
                    <p className="py-4 ">are you sure you want to delete course <span className=" font-bold text-boxdark dark:text-white"> {text}</span> </p>
