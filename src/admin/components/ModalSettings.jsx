            ...
            <div className="grid grid-cols-3 gap-5 justify-normal">
                    ...
                    {formState.criterion === '0' ? 'goes down by' :
                      formState.criterion === '1' ? 'goes up by' :
                        formState.criterion === '2' ? 'is smaller than' :
                          formState.criterion === '3' ? 'is greater than' :
                            'is equal to'}
                  </span>
                  <select
                    className="absolute top-0 left-0 z-20 h-full w-full bg-transparent opacity-0"
              ...
              <div className="form-group">
                ...
                <div className="relative z-20 w-full rounded border border-stroke p-1.5 pr-8 font-medium outline-none transition focus:border-primary active:border-primary dark:border-strokedark dark:bg-form-input">
                  <div className="flex flex-wrap items-center"></div>
                  <span
                    className={`${formState.type === '0' ? 'bg-[#04b20c]' :
                      formState.type === '1' ? 'bg-[#eab90f]' :
                        'bg-[#e13f32]'} m-1.5 flex items-center justify-center rounded border-[.5px] border-stroke py-1.5 px-2.5 text-white font-medium dark:border-strokedark`}
                  >
                    {formState.type === '0' ? 'Info' :
                      formState.type === '1' ? 'Warning' : 'Alert'}
                  </span>
                  <select
                    className="absolute top-0 left-0 z-20 h-full w-full bg-transparent opacity-0"
                    name="type"
